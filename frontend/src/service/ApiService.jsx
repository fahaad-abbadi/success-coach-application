...
export default class ApiService {
  ...
  static async updatePost(postId, postData) {
    const response = await axios.put(
      `${this.BASE_URL}/posts/update/${postId}`,
      postData,
      { headers: this.getHeader() }
    );
    return response.data;
  ...
  static async addComment(postId, commentData) {
    const response = await axios.post(
      `${this.BASE_URL}/comments/add/${postId}`,
      commentData,
      { headers: this.getHeader() }
    );
    return response.data;
  ...
  static async getCommentsByPostId(postId) {
    const response = await axios.get(
      `${this.BASE_URL}/comments/post/${postId}`,
      { headers: this.getHeader() }
    );
    return response.data;
  }
  ...
  static async getCommentById(commentId) {
    const response = await axios.get(`${this.BASE_URL}/comments/${commentId}`, {
      headers: this.getHeader(),
    });
    return response.data;
  }
  ...
  static async deleteComment(commentId) {
    const response = await axios.delete(
      `${this.BASE_URL}/comments/delete/${commentId}`,
      { headers: this.getHeader() }
    );
    return response.data;
  }
  ...
  // ADMIN ANNOUNCEMENTS
  static async createAnnouncement(content) {
    // POST request with raw content as request body (or use { content: ... } if you prefer)
    const response = await axios.post(
      `${this.BASE_URL}/admin/announcements`,
      content,
      {
        headers: this.getHeader(),
      }
  ...
  static async getLatestAnnouncement() {
    const response = await axios.get(`${this.BASE_URL}/announcements/latest`, {
      headers: this.getHeader(),
    });
    return response.data;
  }
  ...
  static async getAllAnnouncements() {
    const response = await axios.get(`${this.BASE_URL}/announcements`, {
      headers: this.getHeader(),
    });
    return response.data;
  }
  ...
  static async getPostsByCategory(categoryId) {
    const response = await axios.get(
      `${this.BASE_URL}/categories/${categoryId}/posts`,
      { headers: this.getHeader() }
    );
    return response.data;
  }
  ...
  // Upvote and Downvote
  static async votePost(postId, type) {
    const response = await axios.post(
      `${this.BASE_URL}/votes/post/${postId}?type=${type}`,
      {}, // no request body
      { headers: this.getHeader() } // correct header placement
    );
    return response.data;
  }
  
  static async voteComment(commentId, type) {
    const response = await axios.post(
      `${this.BASE_URL}/votes/comment/${commentId}?type=${type}`,
      {}, // no body
      { headers: this.getHeader() }
    );
    return response.data;
